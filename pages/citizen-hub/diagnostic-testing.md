...
## On this page
- [When diagnosis is hard to reach](#when-diagnosis-is-hard-to-reach)
...
## When diagnosis is hard to reach
...
Genomic testing has been especially valuable in the field of rare diseases. Many rare conditions are genetic in origin, and newer testing techniques now make it possible to reach a diagnosis more quickly and accurately than in the past.

## Limits, uncertainty and support

It's important to manage expectations. Genetic test results are not always straightforward. Sometimes a genetic variant is identified, but scientific knowledge about what it means is limited, or its future impact is uncertain.
...
Although the cost of genomic sequencing has fallen significantly, the actual cost of testing varies depending on the type of test and whether it is reimbursed. This affects how accessible testing is in practice.

The likelihood of reaching an accurate diagnosis can also vary between populations. Today’s genomic databases are still based mainly on people of European ancestry. As a result, individuals from underrepresented populations may face less accurate interpretation of results and lower diagnostic rates.
